...
function HandHologramVisual({
  ...
  return (
    <div
      className={`${
        styles.handHologramWrap
      } ${
        ambient
          ? styles.handHologramAmbient
          : ""
      }`}
      aria-hidden="true"
    >
      ...
      >
        <defs>
          ...
          <radialGradient
            ...
            gradientTransform="translate(200 128) scale(105)"
          >
            <stop
              offset="0%"
        ...
        <path
          ...
          d="M188,300 L196,175 L204,175 L212,300 Z"
        />
        ...
        >
          <path d="M200,78 L241,109 L226,152 L174,152 L159,109 Z" />
          <path d="M200,78 L200,128" />
          <path d="M174,152 L226,152" />
          <path d="M159,109 L200,128 L241,109" />
        </g>
        ...
        >
          ...
          <circle cx="241" cy="109" r="4" />
          <circle cx="226" cy="152" r="4" />
          <circle cx="174" cy="152" r="4" />
          <circle cx="159" cy="109" r="4" />
        </g>
        ...
        <g
          className={
            styles.handParticles
          }
        >
          <circle cx="140" cy="88" r="2.2" />
          <circle cx="268" cy="72" r="2.6" />
          <circle cx="258" cy="182" r="2.2" />
          <circle cx="128" cy="198" r="2.4" />
        </g>

        <g
          className={
            styles.handSilhouette
          }
        >
          <path d="M130,330 Q128,255 200,250 Q272,255 270,330 L270,398 Q270,414 254,414 L146,414 Q130,414 130,398 Z" />
          <rect
            x="112"
            y="288"
            width="46"
